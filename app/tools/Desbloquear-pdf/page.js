    ...
    return (
        <>
            <div className={"droppdf"}>
                <b className={"unirArchivosPdf"}>Desbloquear archivos PDF</b>
                <div className={"unePdfY"}>Desbloquea tus archivos PDF y ponlos en el orden que prefieras. ¡Rápido y fácil!</div>
                <div className={"drop"}>
