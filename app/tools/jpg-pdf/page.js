    ...
    return (
        <>
            <div className={"droppdf"}>
                <b className={"unirArchivosPdf"}>Convertir archivos JPG a PDF</b>
                <div className={"unePdfY"}>convierte tus archivos JPG a PDF y ponlos en el orden que prefieras. ¡Rápido y fácil!</div>
                <div className={"drop"}>
