    ...
    return (
        <>
            <div className={"droppdf"}>
                <b className={"unirArchivosPdf"}>Convertir archivos PDF a JPG</b>
                <div className={"unePdfY"}>convierte tus archivos PDF a JPG y ponlos en el orden que prefieras. ¡Rápido y fácil!</div>
                <div className={"drop"}>
